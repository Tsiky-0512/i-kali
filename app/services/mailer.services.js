...
exports.mail = async (to,code) => {
    try {
        ...
        await transporter.sendMail({
            from: '"Ikaly" noreply.ikaly@gmail.com', // sender address
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                          <p style="margin: 0;">Bienvenue sur <strong style="color: #1e647d;">I-kaly service</strong> , Je vous remercie d'avoir cr&eacute;er votre compte . Pour finaliser , veuillez sasir ce code suivant </p>
                        </td>
                      </tr>
                      <!-- end copy -->
                            ...
                            <tr>
                              <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td align="center" bgcolor="#1e647d" style="border-radius: 6px;">
                      ...
                      <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                          <p style="margin: 0;">Cheers,<br> mazotoa m<strong>I-kaly</strong></p>
                        </td>
                      </tr>
                      <!-- end copy -->
                ...
                <tr>
                  <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <tr>
                        <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                          <p style="margin: 0;">Rasolofomanana tsiky | developer fullstack </p>
                          <p style="margin: 0;"> <a href="https://www.linkedin.com/in/tsiky-rasolofomanana-43207a191/">linkedin</a></p>
                        </td>
                      </tr>
                      <!-- end unsubscribe -->
